...
#SBATCH --time=230:00:00 # Time limit hrs:min:sec
...
java -Djava.io.tmpdir=/scratch/Users/allenma/tmp/${SLURM_JOBID} -XX:ParallelGCThreads=16 -jar /opt/picard/2.6.0/picard-2.6.0.jar MarkDuplicates I=${WKDIR}/merged_files/${rootname}.bam O=${WKDIR}/merged_files_markdups/${rootname}.bam 
